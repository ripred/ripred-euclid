...
- Keep package metadata and install/run instructions current.
...
For JavaScript or TypeScript changes, run the project test/build command documented in the README or package scripts.
